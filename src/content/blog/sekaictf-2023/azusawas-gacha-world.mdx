...
| `public void GenericModalHandler(){:cs}`               | **Parameters**: `GameObject modal, Button closeButton{:cs}`<br />Plays the default zoom-in/zoom-out animations, sound effects, and enables darkened background whenever a modal is opened via button: ![Modal Handler](assets/modal-handler.gif)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
